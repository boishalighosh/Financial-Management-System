...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
	...
	$id=$_POST['id'];
	$pass=$_POST['pass'];
	$sql="select * from employee where E_Id='$id' and E_DOB='$pass'";
	...
	if($num==1)
	{
		...
		$_SESSION['Id']=$Id;
		header("location:homee.php?id=$id");
	}
	else
	{
		$error=true;
...
<html>
	...
	<body>
		<div class="container">
			...
			<table>
				<tr>
					<td><a href="logine.php" style="text-decoration:none;color:white;padding:5px;font-size:20px;font-weight:bold;border-bottom:5px solid green;">Login as employee</a></td>
					<td align="center"><a href="logina.php" style="text-decoration:none;color:white;font-size:20px;font-weight:bold;">Login as admin</a></td>
				</tr>
				<tr>
					<td><br></td>
				</tr>
