...
<html>
	...
	<body>
		...
		<div id="sidemenu" class="sidenav">
			...
			<a href="reg.php"><i class="fa fa-pencil-square-o"></i>Registration</a>
			<a href="empdetail.php"><i class="fa fa-file-text-o"></i>Employee details</a>
			<a href="#"><i class="fa fa-bar-chart"></i>Progress</a>
			<a href="#"><i class="fa fa-calculator"></i>Running Account Bill</a>
			<a href="#"><i class="fa fa-usd"></i>Price Exclasation</a>
			<div style="position:absolute;top:85%">
				<a href="logouta.php"><i class="fa fa-sign-out"></i>Logout</a>
			</div>
		</div>
		<script>
		...
		<div class="box">
			...
			{
				echo"<p style='color:white;margin-left:30%;'>Name : $row[A_Name]</p>";
				echo"<p style='color:white;margin-left:30%;'>DOB : $row[A_DOB]</p>";
				echo"<p style='color:white;margin-left:30%;'>Gender : $row[A_Gender]</p>";
				echo"<p style='color:white;margin-left:30%;'>Phone : $row[A_Phone]</p>";
				echo"<p style='color:white;margin-left:30%;'>Email : $row[A_Email]</p>";
				echo"<p style='color:white;margin-left:30%;'>Address : $row[A_Address]</p>";
				echo"<p style='color:white;margin-left:30%;'>PAN : $row[A_PAN]</p>";
				echo"<p style='color:white;margin-left:30%;'>AADHAAR : $row[A_AADHAAR]</p>";
			}
			?>
			</p>
		</div>
