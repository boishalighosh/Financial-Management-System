...
if(isset($_POST['submit']))
{
	...
	for($a=0;$a<count($_POST["rabill_no"]);$a++)
	{
		$sql="INSERT INTO `pe` (`s_no`,`rabill_no`,`month`,`work_done`,`variation`,`escalation_amt`,`l_base`,`l_current`,`l_amt`,`m_base`,`m_current`,`m_amt`,`f_base`,`f_current`,`f_amt`,`c_base`,`c_current`,`c_amt`,`s_base`,`s_current`,`s_amt`,`b_base`,`b_current`,`b_amt`,`p_base`,`p_current`,`p_amt`,`total_amt`)
		VALUES ('" .$_POST["id"][$a]. "','" .$_POST["rabill_no"][$a]. "','" .$_POST["month"][$a]. "','" .$_POST["work_done"][$a]. "','" .$_POST["variation"][$a]. "','" .$_POST["excalation_amt"][$a]. "','" .$_POST["l_base"][$a]. "','" .$_POST["l_current"][$a]. "','" .$_POST["l_amt"][$a]. "','" .$_POST["m_base"][$a]. "','" .$_POST["m_current"][$a]. "','" .$_POST["m_amt"][$a]. "','" .$_POST["f_base"][$a]. "','" .$_POST["f_current"][$a]. "','" .$_POST["f_amt"][$a]. "','" .$_POST["c_base"][$a]. "','" .$_POST["c_current"][$a]. "','" .$_POST["c_amt"][$a]. "','" .$_POST["s_base"][$a]. "','" .$_POST["s_current"][$a]. "','" .$_POST["s_amt"][$a]. "','" .$_POST["b_base"][$a]. "','" .$_POST["b_current"][$a]. "','" .$_POST["b_amt"][$a]. "','" .$_POST["p_base"][$a]. "','" .$_POST["p_current"][$a]. "','" .$_POST["p_amt"][$a]. "','" .$_POST["total_amt"][$a]. "')";
...
<html>
	...
	<body>
		<form action="pe.php" method="post">
			...
			<a href="#" onclick="add()"><i class="fa fa-plus"></i>ADD</a>
		</form>
		<script>
			function add()
			{
				var html="<tr>";
					html +="<td><input name='id[]' size='1'></td>";
					html +="<td><input name='rabill_no[]' size='15'></td>";
					html +="<td><input name='month[]' size='15'></td>";
					html +="<td><input name='work_done[]' size='15'></td>";
					html +="<td><input name='variation[]' size='15'></td>";
					html +="<td><input name='excalation_amt[]' size='15'></td>";
					html +="<td><input name='l_base[]' size='15'></td>";
					html +="<td><input name='l_current[]' size='15'></td>";
					html +="<td><input name='l_amt[]' size='15'></td>";
					html +="<td><input name='m_base[]' size='15'></td>";
					html +="<td><input name='m_current[]' size='15'></td>";
					html +="<td><input name='m_amt[]' size='15'></td>";
					html +="<td><input name='f_base[]' size='15'></td>";
					html +="<td><input name='f_current[]' size='15'></td>";
					html +="<td><input name='f_amt[]' size='15'></td>";
					html +="<td><input name='c_base[]' size='15'></td>";
					html +="<td><input name='c_current[]' size='15'></td>";
					html +="<td><input name='c_amt[]' size='15'></td>";
					html +="<td><input name='s_base[]' size='15'></td>";
					html +="<td><input name='s_current[]' size='15'></td>";
					html +="<td><input name='s_amt[]' size='15'></td>";
					html +="<td><input name='b_base[]' size='15'></td>";
					html +="<td><input name='b_current[]' size='15'></td>";
					html +="<td><input name='b_amt[]' size='15'></td>";
					html +="<td><input name='p_base[]' size='15'></td>";
					html +="<td><input name='p_current[]' size='15'></td>";
					html +="<td><input name='p_amt[]' size='15'></td>";
					html +="<td><input name='total_amt[]' size='15'></td>";
				html +="</tr>";
